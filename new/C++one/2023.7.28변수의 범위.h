...
// 프로그램이 종료되어야만 메모리에서 해제되는 변수이다.
void ShowStat()
{
	// 단 한번만 초기화가 이루어진다.
	static int score = 0; // 다른사람이 건드리지 못하게 하기위해서 사용함
...
#pragma region 단축 평가 (Short-curcuit)
	...
	// 두 번째 인수가 평가되는 일부 프로그래밍 언어의 일부 논리 연산이다.
